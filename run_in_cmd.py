...
# Original file: D:\codetest\rlpp_ori\run_in_cmd.py
# Migration may not be complete. 
# Please review TODO comments.
# ===================================

import common       # do some work!
import argparse
from Run.data import DataArgs
from Run.run import run


if __name__ == "__main__":
    # parser = argparse.ArgumentParser()
    # parser.add_argument('train', type=bool, help="train or predict")   #
